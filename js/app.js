(() => {
  ...
  (() => {
          ...
          return (
            i.forEach((t) => {
              const a = t.split(","),
                s = a[1],
                i = a[2],
                p = window.matchMedia(a[0]),
                r = e.filter(function (e) {
                  if (e.value === s && e.type === i) return !0;
                });
              l.push({ itemsArray: r, matchMedia: p });
            }),
            l
          );
      }
        ...
        if (e.length) {
          this.scrollWatcherLogging(
            ...
            s(
              ...
              let a = t.split("|"),
                s = { root: a[0], margin: a[1], threshold: a[2] },
                ...
                l = this.getScrollWatcherConfig(s);
              this.scrollWatcherInit(i, l);
            });
        } else
    ...
    setTimeout(() => {
      ...
      (p.prototype.init = function () {
        ...
        for (let t = 0; t < this.mediaQueries.length; t++) {
          const a = this.mediaQueries[t],
            ...
            l = s[1],
            p = Array.prototype.filter.call(this.оbjects, function (e) {
              return e.breakpoint === l;
            });
          i.addListener(function () {
            e.mediaHandler(i, p);
          }),
            this.mediaHandler(i, p);
        }
      }),
      ...
      (p.prototype.moveTo = function (e, t, a) {
      ...
      (p.prototype.moveBack = function (e, t, a) {
    ...
    (window.FLS = !0),
      ...
      (function () {
        ...
        if (e.length > 0) {
          const s = Array.from(e).filter(function (e, t, a) {
          ...
          function n(e) {
            ...
            if (s.closest("[data-spoller]")) {
              const i = s.closest("[data-spoller]"),
                ...
                p = !!l.hasAttribute("data-one-spoller");
              l.querySelectorAll("._slide").length ||
                (p && !i.classList.contains("_spoller-active") && o(l),
                i.classList.toggle("_spoller-active"),
                ((e, s = 500) => {
                  e.hidden ? a(e, s) : t(e, s);
                })(i.nextElementSibling, 200)),
                e.preventDefault();
            }
          }
          function o(e) {
            const a = e.querySelector("[data-spoller]._spoller-active");
            a &&
              (a.classList.remove("_spoller-active"),
              t(a.nextElementSibling, 500));
          }
          l &&
            l.length &&
            l.forEach((e) => {
